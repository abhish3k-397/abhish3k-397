...
- ⌨️ **Terminal Addict** — GUI buttons are just a myth invented by Microsoft. `cd`, `vim`, `cat`, repeat.
- 📦 **Open Source Learner** — Living bleeding-edge in the `AUR` (where instability builds character).
...
## 📊 Activity Matrix
![GitHub Activity Graph](https://github-readme-activity-graph.vercel.app/graph?username=abhish3k-397&theme=tokyonight)
...
`pacman -Syyu && sudo rm -rf / --no-preserve-root` *(Don't actually run this)*
